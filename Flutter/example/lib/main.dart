...
class _DoKitTestPageState extends State<DoKitTestPage> {
  ...
  void testDownload() async {
    ...
    var response = await dio.download(url, '$savePath/$zipName',
  ...
  void testMethodChannel() {
    ...
    timer = Timer.periodic(Duration(seconds: 2), (timer) async {
      const _kChannel = MethodChannel('plugins.flutter.io/package_info');
      final map = await _kChannel.invokeMapMethod<String, dynamic>('getAll');
    });
  }
  ...
  void mockHttpPost() async {
    ...
    timer = Timer.periodic(Duration(seconds: 2), (timer) async {
      ...
      var url = 'https://pinzhi.didichuxing.com/kop_stable/gateway?api=hhh';
