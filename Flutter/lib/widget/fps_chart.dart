...
class BarChartPainter extends CustomPainter {
      ...
      (int index, double label) {
        ...
        TextPainter(
          text: TextSpan(
            ...
            style:  TextStyle(
                fontSize: labelFontSize.toDouble(), color: Color(0xff4a4b5b)),
          ),
  ...
  void _drawBars(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < datas.length; i++) {
      ...
      // 矩形的上边缘为画布高度减去数据值
      final top = sh - value * 2.5;
      // 矩形的左边缘为当前索引值乘以矩形宽度加上矩形之间的间距
      final left = marginLeft + i * _barWidth + (i * _barGap) + _barGap;
